// ========================================
// components/pedidos/DeleteConfirmModal.jsx
// ========================================
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-700 text-center mb-6 text-lg">
            ...
            Los productos quedarán disponibles nuevamente.
          </p>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 px-6 py-3 border-2 border-gray-300 rounded-xl 
                        text-gray-700 font-bold hover:bg-gray-50 transition-all"
            >
              Cancelar
            </button>
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 
                        text-white rounded-xl font-bold hover:from-red-600 hover:to-red-700 
